...
app.post('https://todo-frontend-zeta-coral.vercel.app/auth/register', (req, res) => {
...
app.post('https://todo-frontend-zeta-coral.vercel.app/auth/login', (req, res) => {
...
app.post('https://todo-frontend-zeta-coral.vercel.app/todos', (req, res) => {
...
app.get('https://todo-frontend-zeta-coral.vercel.app/todos', (req, res) => {
...
app.delete('https://todo-frontend-zeta-coral.vercel.app/todos', (req, res) => {
    const { id } = req.query;
    console.log({ id })
    if (!id) {
...
app.put('https://todo-frontend-zeta-coral.vercel.app/todos', (req, res) => {
    const { id } = req.query;
    const { username, todo, priority } = req.body;
    console.log({ id });
