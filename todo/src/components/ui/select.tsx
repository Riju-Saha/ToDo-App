    ...
    ({ className, children, ...props }, ref) => {
        ...
        return (
            ...
            >
                <select
                    className={cn(
                        `flex h-10 w-full outline-none border-none cursor-pointer bg-gray-50 dark:bg-zinc-800 text-black dark:text-white shadow-input rounded-md px-3 py-2 text-sm 
